...
export default {
    ...
    toggle() {
        ...
        if (editor.getPath().substr(-3) !== '.md') return
        ...
        try {
            ...
            //console.log('-------------cheveretoUploadOn: %o', atom.config.get('image-parse-chevereto.cheveretoUploadOn'))
            /*
